...
class DataStoreManager(context: Context) {
    ...
    val preferencesFlow: Flow<UserPreferences> = dataStore.data.map { preferences ->
        UserPreferences(
            ...
            latitud = preferences[PreferencesKeys.LATITUD] ?: -15.84, // Puno Lat
            longitud = preferences[PreferencesKeys.LONGITUD] ?: -70.02, // Puno Lon
            nombreCiudad = preferences[PreferencesKeys.NOMBRE_CIUDAD] ?: "Puno",
